...
namespace BankSystemProject_WindowsFormApp1
{
    public partial class frmTransactionsScreen : Form
    {
        ...
        private void _SendUserNameANDPassWordToTransactionsOptions()
        {
            ctrlTransactionsScreen_TransactionsOptions1.UserName = _UserName;
            ctrlTransactionsScreen_TransactionsOptions1.PassWord = _PassWord;
        }
        ...
        //Constructor :-
        public frmTransactionsScreen(string UserName, string PassWord)
        {
            InitializeComponent();
        ...
        private void frmTransactionsScreen_Load(object sender, EventArgs e)
        {
            ...
            _SendUserNameANDPassWordToTransactionsOptions();
        }
    }
}